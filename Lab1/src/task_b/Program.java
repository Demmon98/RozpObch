...
public class Program extends Application implements EventHandler<Event> {
    ...
    public void start(Stage stage) {
        ...
        main_slider = new Slider(10, 90, 55);
        ...
        semaphore_state = new Label("Threads semafore_state");
        thread1_stop.setDisable(true);
        thread2_stop.setDisable(true);

        VBox center_pane = new VBox();
        center_pane.getChildren().addAll(center_title, thread_box1, thread_box2, semaphore_state);

...
public class Database {
    ...
    public List<Data> readName(long phone) throws InterruptedException {
        lock.startRead();
        System.out.println(Thread.currentThread().getName() + " начало чтения");
        ...
        System.out.println(Thread.currentThread().getName() + " конец чтения");
        lock.endRead();
        return result;
    }
    ...
    public void write(Data data) throws InterruptedException {
        ...
        System.out.println(Thread.currentThread().getName() + " начало записи");
        ...
        Thread.sleep(1500);
        System.out.println(Thread.currentThread().getName() + " конец записи");
        lock.endWrite();
    }
}

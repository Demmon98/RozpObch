...
public class Main {
    ...
    public static void main(String[] args) throws InterruptedException {
        String[] city_names = {"Киев", "Львов", "Чернигов", "Житомир", "Івано-Франковск", "Херсон", "Полтава"
                , "Черкасы", "Черновци", "Тернополь", "Запорожье", "Винница", "Николаев", "Днепр", "Луцк"
                , "Ужгород", "Сумы", "Кропивницкий", "Донецк", "Луганск", "Одесса", "Ровно", "Харьков"
                , "Хмельницкий", "Севастополь", "Симферополь"};

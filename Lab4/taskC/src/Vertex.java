...
public class Vertex {
    ...
    public void findPath(Vertex destination) {
        ...
        System.out.println("Найден путь из города " + this.name + " в " + destination.name);
        System.out.println("Цена: " + price);
        if (path.size() > 1) {
            System.out.println("Необходимые изменения: ");
    ...
    public String toString(){
        ...
        if (adjacencyList.size() == 0) {
            sb.append("Нет соединения с другими городами\n\n");
            return sb.toString();
        }
